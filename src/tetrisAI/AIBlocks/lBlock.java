   ...
   extends Piece
 {
   ...
   public lBlock() {
     ...
     this.blocks[0].setValue(3);
     this.blocks[1].setRow(1);
     this.blocks[1].setColumn(5);
     this.blocks[1].setValue(3);
     this.blocks[2].setRow(1);
     this.blocks[2].setColumn(4);
     this.blocks[2].setValue(3);
     this.blocks[3].setRow(1);
     this.blocks[3].setColumn(3);
     this.blocks[3].setValue(3);
     setState(true, 0);
     
     try {
       this.image = ImageIO.read(getClass().getResource("/resources/orange.png"));
